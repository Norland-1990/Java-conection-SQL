...
public class MenuConection {
    
    // Mantener una única instancia de Scanner
    private static final Scanner sc = new Scanner(System.in);

    public static void main(String[] args) {
        int opcion;

        // Ciclo para mostrar el menú y procesar las opciones seleccionadas
        do {
            System.out.println("************************************");
            ...
            // Asegurarse de manejar la excepción en caso de que ocurra algún problema al leer la entrada
            try {
                opcion = sc.nextInt();
                sc.nextLine();  // Limpiar el buffer
            } catch (Exception e) {
                System.out.println("Error en la entrada. Por favor, ingrese un número válido.");
                sc.nextLine(); // Limpiar el buffer para la siguiente entrada
                opcion = -1;   // Opción inválida para reiniciar el ciclo
            }
        ...
        sc.close();  // Cerrar el scanner solo al final
    }

    // Métodos CRUD
    public static void ingresarProducto() {
        try (Connection conn = BDConection.getConnection()) {
            ...
            // Validar y obtener la fecha de vencimiento
            ...
            while (true) {
                ...
                if (validarFecha(inputFecha)) {
                    ...
                    break;  // Salimos del ciclo si la fecha es válida
                } else {
            ...
            ps.setDate(5, Date.valueOf(fechaVencimiento));  // Usar fecha válida
